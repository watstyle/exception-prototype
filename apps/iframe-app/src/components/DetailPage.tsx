...
function DetailChipIcon({ icon }: { icon: DetailStatusChip["icon"] }) {
  if (icon === "check") {
    return (
      <svg viewBox="0 0 20 20" fill="none" aria-hidden="true" className="h-3 w-3 stroke-current stroke-[1.6]">
...
function LastUpdatedMeta({
  ...
  const containerClass =
    variant === "inline"
      ...
      : "border-t border-slate-200 bg-slate-50/55 px-5 py-2 text-left text-xs text-slate-500";
  return (
  ...
  return (
    <div className="relative block min-w-0 max-w-full">
      <span
        ...
        className="peer gt-order-value-text inline-block max-w-full truncate align-middle text-slate-900 decoration-dotted underline-offset-2 no-underline hover:underline focus-visible:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300"
      >
        {cityStateZip}
      </span>
      <div
      ...
      <main className="flex w-full flex-1 min-h-0 overflow-hidden p-0">
        <div className="grid h-full min-h-0 w-full overflow-hidden lg:grid-cols-[55%_45%] lg:divide-x lg:divide-slate-200">
          <div className="flex h-full min-h-0 min-w-0 flex-col bg-white">
            <header className="sticky top-0 z-30 border-b border-slate-200 bg-[#FFFFFF]">
              <div className="flex h-14 w-full items-center justify-between gap-5 px-8">
                <div className="flex min-w-0 items-center gap-3">
                  <button
                    type="button"
                    onClick={closeDetail}
                    className="inline-flex shrink-0 items-center gap-1 rounded-md bg-white px-2 py-1 text-sm font-medium text-slate-700 hover:bg-slate-50"
                  ...
                  <div className="flex min-w-0 items-center gap-2">
                    ...
                    <span className="h-4 w-px shrink-0 bg-slate-200" data-testid="status-group-separator" aria-hidden="true" />
            ...
            <div className="panel-scroll min-h-0 flex-1 divide-y divide-slate-200 overflow-y-auto overflow-x-hidden px-8 py-0" data-testid="left-panel-scroll">
              <section data-testid="order-details-section" className="py-5">
                  <div
                            ...
                            <div className="space-y-2" data-testid="order-reference-section">
                              <div className="grid min-h-[24px] grid-cols-[150px_minmax(0,1fr)] items-center gap-x-4">
                                ...
                                <div className="group/copy flex min-w-0 max-w-full items-center gap-1" data-copy-group>
                                  <div className="gt-order-value-text min-w-0 truncate tabular-nums text-slate-900">
                                    {detailFixture.orderDetails.orderId}
                                  </div>
                                  <InlineCopyButton
                              ...
                              <div className="grid min-h-[24px] grid-cols-[150px_minmax(0,1fr)] items-center gap-x-4">
                                <span className="gt-label-text text-slate-500">Customer</span>
                              ...
                              <div className="grid min-h-[24px] grid-cols-[150px_minmax(0,1fr)] items-center gap-x-4">
                                <span className="gt-label-text text-slate-500">Origin</span>
                                <div className="min-w-0">
                                  <AddressHoverDetails
                              ...
                              <div className="grid min-h-[24px] grid-cols-[150px_minmax(0,1fr)] items-center gap-x-4">
                                <span className="gt-label-text text-slate-500">Destination</span>
                                <div className="min-w-0">
                                  <AddressHoverDetails
                              ...
                              <div data-testid="references-section" className="grid min-h-[24px] grid-cols-[150px_minmax(0,1fr)] items-center gap-x-4">
                                <span className="gt-label-text text-slate-500">Ship ID</span>
                                <div className="group/copy flex min-w-0 max-w-full items-center gap-1" data-copy-group>
                                  <div
                                    className="gt-order-value-text min-w-0 truncate tabular-nums text-slate-900"
                                ...
                                {detailFixture.timeline.map((milestone) => {
                                  ...
                                  return (
                                    <li
                                      ...
                                      className="grid min-h-[24px] min-w-0 grid-cols-[minmax(0,1fr)_60px] items-center gap-x-2"
                                    >
                                      <span className="truncate gt-label-text text-slate-500" data-testid={`timeline-label-${milestoneKey}`}>
                                        {milestone.label}
                                      </span>
                                      <span
                                        className={`gt-order-value-text text-right tabular-nums ${
              ...
              <section data-testid="exception-section" className="py-5">
                  <div className="overflow-hidden" data-testid="exception-card">
                      <div>
                        ...
                        <a
                          ...
                          className="mt-5 inline-flex h-10 w-full items-center justify-center gap-1.5 rounded-md border-2 border-[#D9D9D9] bg-white px-3 text-sm font-medium text-slate-700 hover:bg-slate-50"
              ...
              <section data-testid="evidence-section" className="py-5">
                  <div data-testid="evidence-shell">
                      <div>
                              ...
                              <div
                                ...
                                className={`group relative w-full cursor-pointer rounded-lg border p-4 text-left transition ${
                                  isSelected
                                    ...
                                    : "border-slate-200 bg-white shadow-sm hover:border-slate-200 hover:bg-slate-50"
            ...
            <div
              className="sticky bottom-0 z-20 shrink-0 bg-white px-8 py-6 shadow-[0_-6px_14px_rgba(15,23,42,0.08),0_-1px_3px_rgba(15,23,42,0.05)]"
          ...
          <aside className="relative flex h-full min-h-0 min-w-0 flex-col bg-[#F9F9F9]" data-testid="right-panel">
            <header className="sticky top-0 z-30 border-b border-slate-200 bg-[#FFFFFF]" data-testid="right-panel-header">
